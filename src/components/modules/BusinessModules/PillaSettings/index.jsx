...
import APIKeysWebhook from "./Pages/APIKeysWebhook";
  ...
  const usePage = [
    {
      ...
      component: (
        <PersonalInformation
          pageName={pageName}
          getTitleName={"Personal Information"}
        />
      ),
    },
    {
      ...
      component: (
        <BusinessInformation
          pageName={pageName}
          getTitleName={"Business Information"}
        />
      ),
    },
    {
      ...
      component: (
        <SettlementAccount
          ...
          onNext={() => setPageOffCanvas("Add Settlement Account")}
        />
      ),
    },
    {
      name: "Notifications",
      component: (
        <NotificationSettings pageName={pageName} getTitleName={getTitleName} />
      ),
    },
    {
      name: "Preferences",
      component: (
        <Preferences pageName={pageName} getTitleName={'Notifications'} />
      ),
    },
    {
      name: "API Keys & Webhook",
      component: (
        <APIKeysWebhook pageName={pageName} getTitleName={'API Configuration'} />
      ),
    },
    {
      name: "Security",
        ...
        <div className="row gx-4">
            ...
            <Container Wrapper={"min-vh-100 h-100 border"}>
              <Container Wrapper={"bg-grayIII border-0 rounded-0"}>
                <div className="d-flex justify-content-start align-items-center gap-2  ">
                  <div
                    className="rounded-circle h5t  d-flex align-items-center justify-content-center font-2"
                    style={{
                      width: "64px",
                      height: "64px",
                      background: "#CCCCCC",
                  ...
                  <div>
                    <div className="h3t grayIV  fw-1 font-2">
                      <span className="blackI">Peter Simon</span>
                    </div>
                    <div className="h6tt success d-flex gap-1 align-items-center">
                      <FallbackImage
              ...
              {SettingData()?.map(({ name, titleName, action }, i) => (
                <div
                  ...
                  className={`d-flex justify-content-between font-2 align-items-center pt-3 pb-4 ps-4 pe-2 pointer ${" border-bottom"} ${
                    titleName === pageName ? "primaryII successII" : ""
                  }`}
                  key={i}
                >
                  <div className={`h3t fw-1 ${pageName === name && "successII"}`}>
                    {name}
                  </div>
          ...
          <div className={`col-8 `}>
            ...
            <OffCanvas
              ...
              pageName={pageOffCanvas}
              onClose={() => setPageOffCanvas()}
            />
          </div>
        </div>
      </div>
