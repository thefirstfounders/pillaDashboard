...
import ApplyForLoan from "../../PillaFinance/ApplyForLoan/ApplyforLoan";
import CheckCredit from "../../PillaFinance/CheckCredit/CheckCredit";
import PayRent from "../../PillaFinance/PayRent/PayRent";
  ...
  return (
    <section>
     ...
     <div className="row g-3 ">
        ...
        <div className="bg-white  rounded1">
          ...
          <div className="col-lg-6">
          <Container Wrapper={'border h-100'}>
