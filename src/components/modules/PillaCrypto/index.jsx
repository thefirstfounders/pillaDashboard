...
import { CryptoTransactionsData, CryptoTransactionsHeader } from "@/utils/TableColumns";
  ...
  return (
    <section>
      <section className="mb-5">
        <div style={{backgroundColor:'#0024A8'}} className=" py-4 text-white rounded py-3 px-4 position-relative">
         <ImageBackGround
         image={'/Images/Crypto/bg1.png'}
         />
          <div className="d-flex justify-content-between align-items-center position-relative">
            ...
            <div>
              <ButtonComp
              btnText={<span className="d-flex h5tt fw-bold font-1 align-items-center">
                <FallbackImage
          ...
          <div className="row g-4">
            ...
            <Container Wrapper={''}>
              <div className="d-flex align-items-center justify-content-between px-lg-3">
                <div>
                  <DropDown
                  title={<span  className="fw-bold"> <FallbackImage
                ...
                <div  style={{backgroundColor:'#E5EBFF'}} className="d-flex h6tt gap-3 gap-xl-5 px-2 px-xl-4 py-3 rounded">
