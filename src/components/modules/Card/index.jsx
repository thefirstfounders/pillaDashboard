...
export default function Pilla_Card() {
  ...
  const usePage =[
    ...
    },
    {
        name:'Transaction',
        component:<div>
          <div className="h4t">Transactions</div>
          <div>
            <TableCompData
  ...
  return (
    <section className="pb-5">
      <div className="row gx-4">
        <div className="col-lg-6 col-xl-4">
          <div className="card border-0 " style={{ minHeight: "85vh" }}>
            ...
            <TopButtons setCard={setCard} getCard={getCard}/>
              ...
              <div className=" rounded  mb-5" style={{background:'#E6E6E6',padding:'8px'}}>
                  <AtmCard
                  bgColor={'#002199'}
        ...
        {false ? <CardEmptyState/>:
        <div className="card border-0 h-100">
          <div className="card-body px-4">
              <section className="row rounded-pill mb-5" style={{backgroundColor:'#F2F2F2', padding:'5px'}}>
                <div className="col-6 px-0">
                  <ButtonComp
                  btnText={'Card Details'}
                  onClick={()=>setSide('Card Details')}

                  btnClassName={`h5tt font-1 w-100 border-0 rounded-pill fw-bold ${getSide==="Card Details"?'bg-white animate__fadeIn animate__animated':'bg-grayIII'}`}
                  />
                </div>
                <div className="col-6 px-0">
                  <ButtonComp
                  ...
                  btnClassName={`h5tt font-1 w-100 border-0 rounded-pill fw-bold ${getSide==="Transaction"?'bg-white animate__fadeIn animate__animated':'bg-grayIII'}`}
                  />
                </div>
              </section>
                <PageSwitch
      ...
      <OffCanvas arrayComp={useOffCanvas}  pageName={pageName} setPageName={setPageName} onClose={()=>setPageName()} />
    </section>
  );
}
