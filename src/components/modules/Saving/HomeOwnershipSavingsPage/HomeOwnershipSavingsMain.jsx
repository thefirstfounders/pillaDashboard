...
export default function HomeOwnershipSavingsMain({setPageName}) {
  return (
    <div>
          <div className="primaryII py-4 px-3 rounded mb-4">
            <p className="grayII mb-1">Home Ownership Savings</p>
            <h4 className="fw-bold blackII mb-1">₦ 200,000.00</h4>
